package com.el.cloud.common.config;

import com.el.cloud.common.context.SpringCloudHystrixConcurrencyStrategy;
import com.el.cloud.common.intercepter.FeignUserContextInterceptor;
import com.el.cloud.common.intercepter.RestTemplateUserContextInterceptor;
import com.el.cloud.common.intercepter.UserContextInterceptor;
import feign.Feign;
